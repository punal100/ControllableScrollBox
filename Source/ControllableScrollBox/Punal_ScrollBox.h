...
#include "Punal_ScrollBox.generated.h"

//DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnUserScrolledEvent, float, CurrentOffset);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnMouseScrollEvent, const FGeometry&, MyGeometry, const FPointerEvent&, MouseEvent);

/**
 * An arbitrary scrollable collection of widgets.  Great for presenting 10-100 widgets in a list.  Doesn't support virtualization.
 */
UCLASS()
class CONTROLLABLESCROLLBOX_API UPunal_ScrollBox : public UPanelWidget
{
...
protected:
	...
	TSharedPtr<class SPunal_ScrollBox> MyScrollBox;
