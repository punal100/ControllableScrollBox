...
#include "Punal_ScrollBoxSlot.generated.h"

/** The Slot for the UScrollBox, contains the widget that are scrollable */
UCLASS()
class CONTROLLABLESCROLLBOX_API UPunal_ScrollBoxSlot : public UPanelSlot
{
...
public:
	...
	void BuildSlot(TSharedRef<SPunal_ScrollBox> ScrollBox);
